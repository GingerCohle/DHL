...
def _foward_detector(cfg, model, images, targets=None, return_maps=False):
    ...
    images_tensor = normalize(mean=cfg.INPUT.PIXEL_MEAN, std=cfg.INPUT.PIXEL_STD, to_bgr255= cfg.INPUT.TO_BGR255, image=images.tensors)
    features = model_backbone(images_tensor)
